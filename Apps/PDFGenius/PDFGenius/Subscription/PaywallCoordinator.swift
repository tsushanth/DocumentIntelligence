...
final class PaywallCoordinator: ObservableObject {
    ...
    private let dismissCountKey = "pdfGenius_paywallDismissCount"
    private let lastDismissDateKey = "pdfGenius_lastPaywallDismissDate"
    private let lastWinbackShownKey = "pdfGenius_lastWinbackShownDate"
