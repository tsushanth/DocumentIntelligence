...
struct WinbackOfferView: View {
    ...
    private let valueProps: [(icon: String, text: String)] = [
        ("doc.richtext.fill", "Unlimited PDF editing"),
        ("sparkles", "AI document analysis"),
        ("doc.text.viewfinder", "OCR text extraction"),
        ("arrow.triangle.merge", "Merge & split PDFs")
    ]
            ...
            ScrollView {
                VStack(spacing: 28) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("Come back and unlock everything PDFGenius has to offer.")
                            .font(.subheadline)
