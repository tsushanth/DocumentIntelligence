...
@objc(FolderEntity)
public class FolderEntity: NSManagedObject, Identifiable {

    @NSManaged public var id: UUID
    @NSManaged public var name: String
    @NSManaged public var color: String?
    @NSManaged public var createdAt: Date
    @NSManaged public var documents: Set<DocumentEntity>?

    /// Fetch request for FolderEntity entities
    ...
    public var sortedDocuments: [DocumentEntity] {
...
extension FolderEntity {
    ...
    static func createEntityDescription(in model: NSManagedObjectModel) -> NSEntityDescription {
        ...
        entity.managedObjectClassName = NSStringFromClass(FolderEntity.self)
...
extension FolderEntity {
    ...
    public func addDocument(_ document: DocumentEntity) {
        var docs = documents ?? Set<DocumentEntity>()
    ...
    public func removeDocument(_ document: DocumentEntity) {
        var docs = documents ?? Set<DocumentEntity>()
